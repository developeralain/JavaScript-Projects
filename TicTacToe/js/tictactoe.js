...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            //if activePlayer is equal to 'X', the x2.jpg is placed in HTML.
            select.style.backgroundImage = 'url("images/y121.jpg")';
            //active player may only be 'X' or 'O' so, if not 'X' it must be 'O'
        } else {
            //if activePlayer is equal to 'O', the 02.jpg is placed in HTML.
            select.style.backgroundImage = 'url("images/slice.jpg")';
        }
        ...
        //this functions plays placement sound.
...
//this function resets the game in the eve nt of a tie or a win.
function resetGame() {
    ...
    for (let i = 0; i < 9; i++) {
        ...
        //this//this resets our array so it is empty and we can start over. 
        selectedSquares = [];
    }
}
