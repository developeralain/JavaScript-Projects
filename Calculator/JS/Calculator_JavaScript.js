...
function Input_Digit(digit) {
    ...
    if (Wait_Second_Operand === true) {
        ...
        Calculator.Display_Value = Display_Value === '0' ? digit : Display_Value + digit;//what this is saying is if it is true that Display_Value 
        //is === 0 then digit will be the displayed whereas if it is false that Display_Value === 0 then digit + current display value, whatever it
        //is, will be displayed ... this tertiary ? operator basically condenses an if...else statement into less code
    }
...
function Handle_Operator(Next_Operator) {
    ...
    if (First_Operand == null) {
        ...
        //here we add a fixed ampount of numbers after the decimal
